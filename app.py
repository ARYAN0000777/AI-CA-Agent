...
<div class="khata-topbar">
  ...
  <div class="khata-pill">v3.0 VOICE</div>
</div>
""", unsafe_allow_html=True)
...
with tab2:
    ...
    # Audio widget wrapped in Claude's styled container
        ...
        if st.button("🚀 Generate Bill from Voice", use_container_width=True):
            with st.spinner("AI is listening to your voice and making the bill..."):
                try:
                    ...
                    """
                    # New API logic format to avoid validation error
